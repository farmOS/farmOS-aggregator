...
def test_valid_login(client):
    ...
    """
    print(farmOSaggregator.app.config['BASIC_AUTH_USERNAME'])
    response = login(client, farmOSaggregator.app.config['BASIC_AUTH_USERNAME'], farmOSaggregator.app.config['BASIC_AUTH_PASSWORD'])
