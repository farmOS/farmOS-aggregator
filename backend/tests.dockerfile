...
RUN pip install requests pytest tenacity passlib[bcrypt] celery~=4.3 "fastapi==0.47.1" "pydantic==1.4" email_validator pyjwt psycopg2-binary SQLAlchemy "farmOS==0.1.6b3"
